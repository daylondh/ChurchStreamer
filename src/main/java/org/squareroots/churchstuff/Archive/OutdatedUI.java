package org.squareroots.churchstuff.Archive;
...
public class OutdatedUI extends JPanel {
    ...
    public void startStreamButtonClicked(ActionEvent event) {
        ...
        if (_isStreaming) {
            ...
            _buttonStartStream.setText("StartStreaming Streaming");
            _buttonStartStream.setBackground(Color.green);
            ...
            _buttonStartStream.setText("StopStreaming Streaming");
