...
public class UploadVideo {
    ...
    public static void go(final String PATH_TO_FILE, String title, String privacy) {
        ...
        try {
            ...
            snippet.setDescription("The test upload Protocol of the SquareRoots ChurchStreamer"); // TODO: 10/21/2018 Add params that determine title and description
                ...
                public void progressChanged(MediaHttpUploader uploader) throws IOException {
                    switch (uploader.getUploadState()) {
                        case INITIATION_STARTED:
                            CSLogger.logData("Initiation Started");
                            System.out.println("Initiation Started");
                            break;
                        case INITIATION_COMPLETE:
                            CSLogger.logData("Initiation Completed");
                            System.out.println("Initiation Completed");
                            break;
                        case MEDIA_IN_PROGRESS:
                            CSLogger.logData("Upload in progress.");
                            System.out.println("Upload in progress");
                            CSLogger.logData("Progress: " + uploader.getNumBytesUploaded() + " bytes");
